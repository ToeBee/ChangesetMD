...
class ChangesetHandler(xml.sax.handler.ContentHandler):
    ...
    def endElement(self, name):
        if name == "changeset":
            ...
            (id, user_id, min_lat, max_lat, min_lon, max_lon, num_changes, user_name) 
            values (%s,%s,%s,%s,%s,%s,%s,%s)''', (self.changeset.id, self.changeset.userId, self.changeset.minLat, self.changeset.maxLat, self.changeset.minLon, self.changeset.maxLon, self.changeset.numChanges, self.changeset.userName))
